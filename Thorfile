  ...
  def build
    Dir.chdir './packer' do
      ...
      templates.each do |template|
        ...
        elsif options[:os] == 'debian' && options[:os_version] == '8.11.0'
          system "curl -s \"https://vagrantcloud.com/api/v1/box/ffuenf/#{options[:os]}-#{options[:os_version]}-amd64/versions\" -X POST -d version[version]=\"#{options[:atlas_version]}\" -d version[description]=\"### tools\n* VMware Tools 10.2.5\n* VirtualBox Guest Additions 5.2.18\n* Chef 14.4.56-1\n* Ruby 2.1.5-2+deb8u3\n* Rubygems 2.7.7\n\r### source\n[packer templates on github](https://github.com/ffuenf/vagrant-boxes)\" -d access_token=\"$PACKER_ATLAS_TOKEN\""
        elsif options[:os] == 'ubuntu' && options[:os_version] == '16.04.4' && options[:os_version] == '17.10.1'
          system "curl -s \"https://vagrantcloud.com/api/v1/box/ffuenf/#{options[:os]}-#{options[:os_version]}-amd64/versions\" -X POST -d version[version]=\"#{options[:atlas_version]}\" -d version[description]=\"### tools\n* VMware Tools 10.2.5\n* VirtualBox Guest Additions 5.2.18\n* Chef 14.4.56-1\n* Ruby 2.3.1-2~16.04.9\n* Rubygems 2.7.7\n\r### source\n[packer templates on github](https://github.com/ffuenf/vagrant-boxes)\" -d access_token=\"$PACKER_ATLAS_TOKEN\""
        elsif options[:os] == 'ubuntu' && options[:os_version] == '18.04.1'
        ...
        system "curl -s \"https://vagrantcloud.com/api/v1/box/ffuenf/#{options[:os]}-#{options[:os_version]}-amd64/version/#{options[:atlas_version]}/release\" -X PUT -d access_token=\"$PACKER_ATLAS_TOKEN\""
      end
    end
  end
